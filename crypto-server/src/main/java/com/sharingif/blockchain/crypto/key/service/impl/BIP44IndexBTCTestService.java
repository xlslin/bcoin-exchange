...
/**
 * 生成BTC 测试网 index secret key
 */
@Service
public class BIP44IndexBTCTestService implements BIP44IndexService {
    ...
    public SecretKey buildSecretKey(DeterministicKey addressIndexDeterministicKey, String extendedKeyPath, int currentIndexNumber, String password) {
        ...
        secretKey.setAddress(addressIndexDeterministicKey.toAddress(TestNet3Params.get()).toBase58());
    ...
    public int getCoinType() {
        return CoinType.BTC_TEST.getBipCoinType();
    }
}
