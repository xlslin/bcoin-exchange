...
(
  ...
  TX_RECEIPT_STATUS     CHAR(1) NOT NULL COMMENT '交易收据状态(S:成功、F:失败)',
...
(
  ...
  STATUS                VARCHAR(10) NOT NULL COMMENT '账户状态(NORMAL:正常、LOCK:锁定、EXCEPTION:异常)',
  CREATE_TIME           TIMESTAMP NULL COMMENT '创建时间',
  MODIFY_TIME           TIMESTAMP NULL COMMENT '修改时间',
  PRIMARY KEY (ID),
  UNIQUE(ADDRESS,COIN_TYPE)
...
(
  ID                    CHAR(32) NOT NULL COMMENT 'id',
  TRANSACTION_BUSINESS_ID CHAR(32) NOT NULL COMMENT '交易业务表唯一编号',
